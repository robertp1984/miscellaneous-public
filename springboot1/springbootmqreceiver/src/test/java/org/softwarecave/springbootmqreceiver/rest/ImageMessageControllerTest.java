...
@WebMvcTest(controllers = ImageMessageController.class, excludeAutoConfiguration = {SecurityAutoConfiguration.class})
public class ImageMessageControllerTest {
    ...
    public void getImageMessages_returnsListAsJson() throws Exception {
        ImageMessage msg1 = new ImageMessage("id-1", "a.png", "image/png", Instant.now());
        ImageMessage msg2 = new ImageMessage("id-2", "b.jpg", "image/jpeg", Instant.now());
    ...
    public void getImageMessage_existingId_returnsImageMessageJson() throws Exception {
        ImageMessage msg = new ImageMessage("found-id", "file.txt", "text/plain", Instant.now());
