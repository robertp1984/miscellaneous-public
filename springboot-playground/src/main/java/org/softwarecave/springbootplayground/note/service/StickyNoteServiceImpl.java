...
import org.softwarecave.springbootplayground.notification.ActionType;
import org.softwarecave.springbootplayground.notification.ModelType;
import org.softwarecave.springbootplayground.notification.Recordable;
...
public class StickyNoteServiceImpl implements StickyNoteService {
    ...
    public StickyNote addStickyNote(StickyNote stickyNote) {
        ...
        boolean linkHasId = stickyNote.getStickyNoteLinks() != null
                && stickyNote.getStickyNoteLinks()
                .stream()
